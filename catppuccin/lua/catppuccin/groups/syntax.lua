...
function M.get()
	return {
		...
		Function = { fg = C.peach, style = O.styles.functions or {} }, -- function name (also: methods for classes)
		Statement = { fg = C.sapphire }, -- (preferred) any statement
		Conditional = { fg = C.sapphire, style = O.styles.conditionals or {} }, --  if, then, else, endif, switch, etC.
		Repeat = { fg = C.sapphire, style = O.styles.loops or {} }, --   for, do, while, etC.
		Label = { fg = C.sapphire }, --    case, default, etC.
		Operator = { fg = C.sky, style = O.styles.operators or {} }, -- "sizeof", "+", "*", etC.
		Keyword = { fg = C.sapphire, style = O.styles.keywords or {} }, --  any other keyword
		-- Exception     = { }, --  try, catch, throw

		PreProc = { fg = C.mauve }, -- (preferred) generic Preprocessor
