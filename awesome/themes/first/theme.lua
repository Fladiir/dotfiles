...
theme.font          = "Noto Mono for Powerline 10"
...
--theme.titlebar_maximized_button_normal_active = themes_path.."first/titlebar/maximized_normal_active.png"
--theme.titlebar_maximized_button_focus_active  = themes_path.."first/titlebar/maximized_focus_active.png"
